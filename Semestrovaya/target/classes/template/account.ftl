...
<head>
    ...
    <link rel="stylesheet" href='/Semestrovaya_war/resources/CSS/styleForAccount.css'>
...
<div class="site">
    ...
    <div class = "main">
        ...
        <div class="main_section">
            ...
            <#list listEntry as entry>
            <div class="main_section2">
                    <div class="request_text">
                        <div class="text">Имя клиента: ${entry.client.name}</div>
                        <div class="text">Имя мастера: ${entry.master.name}</div>
                        <div class="text">Услуга: ${entry.services.name}</div>
                    </div>
            </div>
            </#list>
