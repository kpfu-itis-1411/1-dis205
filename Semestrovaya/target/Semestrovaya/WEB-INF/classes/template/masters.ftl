...
<head>
    ...
    <link rel="stylesheet" href='/Semestrovaya_war/resources/CSS/styleForMaster.css'>
...
<div class="site">
    ...
    <div class = "main">
        ...
        <div class="main_section">
            ...
            <#list masters as masterlist>
            <div class="main_section2">

                    <div class="master_card">
                        <img class="main__photo" src='\Semestrovaya_war\resources\IMG\masterCut.jpg' alt="Фото мастера">
                        <div class="master_card_text">
                            <div class="master_card_name"> ${masterlist.master.name}</div>
                            <div class="master_card_characterisation"> ${masterlist.master.characterisation}</div>
                            <div class="master_card_work_experience">Опыт работы: ${masterlist.master.workexperience}</div>
                            <div class="master_card_work_valuation">Категория ${masterlist.master.valuation}</div>
                            <div class="master_card_registr">
                                <form method="post" action="/Semestrovaya_war/entry" class="form_btn">
                                    <input type="hidden" name="masterid"  value="${masterlist.master.id}">
                                    <input type="hidden" name="servicesid" value="${masterlist.services.id}">
                                    <button type="submit" class="btnZapis" id="idZapis">${zapis}</button>
                                </form>
                            </div>
                        </div>
